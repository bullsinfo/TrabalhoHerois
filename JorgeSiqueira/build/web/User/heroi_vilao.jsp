...
<html>
	<head>
		<title>Nome do Herói/Vilão - Sistema Heróis</title>
		<meta charset="utf-8" />
		...
		<!-- Page Wrapper -->
			<div id="page-wrapper">
				...
				<!-- Main -->
					<article id="main">
						<header>
							<h2>Nome do Herói/Vilão</h2>
							<p>Este Herói/Vilão pertence a tal editora</p>
						</header>
								<section class="wrapper style5">
									<div class="inner">	
										<h4>História deste Herói/Vilão</h4>
								...
								<section>
									<h4>Informações deste Herói/Vilão</h4>
									<div class="row">
