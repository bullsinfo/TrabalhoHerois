								...
								<li class="special">
									...
									<div id="menu">
										<ul>
											...
											<li><a href="heroi_vilao_list.jsp">Heróis</a></li>
											<li><a href="heroi_vilao_list.jsp">Vilões</a></li>
											<li><a href="dc_marvel_list.jsp">DC</a></li>
											<li><a href="dc_marvel_list.jsp">Marvel</a></li>
				...
				<!-- Banner -->
					<section id="banner">
						<div class="inner">
							...
							quadrinhos.</p>
							<ul class="actions">
								<li><a href="jogador.jsp" class="button special">Meu Perfil</a></li>
							</ul>
						</div>
					...
					<section id="cta" class="wrapper style4">
						<div class="inner">
							...
							<ul class="actions vertical">
								<li><a href="heroi_vilao_list.jsp" class="button fit special">Heróis</a></li>
								<li><a href="heroi_vilao_list.jsp" class="button fit">Vilões</a></li>
							</ul>
						</div>
					</section>
