			...
			<div id="page-wrapper">
				...
				<!-- Main -->
					<article id="main">
						<header>
							<h2>DC/Marvel</h2>
							<p>veja a lista com todos os heróis desta editora</p>
						</header>
						<section class="wrapper style5">
							<div class="inner">

								<h3>História desta editora</h3>
								...
								<section>
									<h4>Lista de Heróis desta editora</h4>
									<div class="row">
										<div class="6u 12u$(medium)">
											<ul class="alt">
												<li><a href="heroi_vilao.jsp">Nome de heroi desta editora</a></li>
												<li><a href="heroi_vilao.jsp">Nome de heroi desta editora</a></li>
												<li><a href="heroi_vilao.jsp">Nome de heroi desta editora</a></li>
												<li><a href="heroi_vilao.jsp">Nome de heroi desta editora</a></li>
												<li><a href="heroi_vilao.jsp">Nome de heroi desta editora</a></li>
